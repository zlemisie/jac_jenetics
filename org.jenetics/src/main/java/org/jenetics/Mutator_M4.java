 ...
 * @version 3.0
 */
public class Mutator_M4<
	G extends Gene<Double, G>,
	...
	extends AbstractAlterer<G, C>
{
	 ...
	 */
	public Mutator_M4(final double probability) {
		super(probability);
	}
...
//				.count();
		...
		DoubleGene x = (DoubleGene)genes.get(0);
		DoubleGene y = (DoubleGene)genes.get(1);
