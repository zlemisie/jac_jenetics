...
import org.jenetics.example.RealFunction4;
	...
	extends AbstractAlterer<BitGene, C>
{
	 ...
	 */
	public Mutator_M7(final double probability) {
		super(probability);
	}
...
//				.count();
	...
	if(a < RealFunction4.getMinV()) return RealFunction4.getMinV();
	if(a > RealFunction4.getMaxV()) return RealFunction4.getMaxV();
	return a;
	}
