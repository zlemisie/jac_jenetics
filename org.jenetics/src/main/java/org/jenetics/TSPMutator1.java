...
import org.jenetics.example.TSP1;
	...
	extends Mutator<EnumGene<Integer>, C>
{
	 ...
	 */
	public TSPMutator1(final double probability) {
		super(probability);
	}
	...
	protected int mutate(final MSeq<EnumGene<Integer>> genes, final double p) {
		...
		ISeq<EnumGene<Integer>> iGenes = ISeq.of(genes);
		PermutationChromosome<EnumGene<Integer>> chromosome = new PermutationChromosome(iGenes);
		Genotype genotype = Genotype.of(chromosome);
