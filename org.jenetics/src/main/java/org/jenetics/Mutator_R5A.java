...
import org.jenetics.example.RealFunction5Ackley;
	...
	extends AbstractAlterer<BitGene, C>
{
	 ...
	 */
	public Mutator_R5A(final double probability) {
		super(probability);
	}
...
//				.count();
	...
	if(a < RealFunction5Ackley.getMinV()) return RealFunction5Ackley.getMinV();
	if(a > RealFunction5Ackley.getMaxV()) return RealFunction5Ackley.getMaxV();
	return a;
	}
	...
	private double evalG(MSeq<Chromosome<BitGene>> c){
		...
		return RealFunction5Ackley.eval(g);
	}
